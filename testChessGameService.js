...
const service = new ChessGameService('3n0eldffb'); // Create a new instance of ChessGameService with a test game ID
...
console.log(service.requestMove({x: 0, y: 1}, {x: 0, y: 3})); // Move a pawn from (0, 1) to (0, 3)
